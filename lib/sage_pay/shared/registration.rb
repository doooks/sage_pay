module SagePay
  module Shared
    class Registration < Command
      ...
      attr_accessor :currency, :description, :billing_address, :delivery_address, :customer_email, :basket, :allow_gift_aid, :apply_avs_cv2, :apply_3d_secure, :billing_agreement, :account_type
      
      decimal_accessor :amount
      
      validates_presence_of :amount, :currency, :description, :billing_address, :delivery_address
      ...
      def shared_registration_params
